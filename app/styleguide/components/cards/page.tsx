...
export default function CardsStyleguidePage() {
  ...
  return (
    <div className="flex flex-col gap-8 p-8 max-w-5xl">
      <div>
        <h1 className="text-2xl font-bold">Card Family</h1>
        <p className="text-muted-foreground mt-1">
          17 reusable card components sharing the same CRM V4 visual language.
        </p>
      </div>
      ...
      {activeTab === "Foundation" && (
        <div className="flex flex-col gap-8">
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Base Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Stat / KPI Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Content Card</h2>
      ...
      {activeTab === "People" && (
        <div className="flex flex-col gap-8">
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Entity Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Profile Card</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <ProfileCard
                avatarFallback="JS"
                name="Jane Smith"
      ...
      {activeTab === "Dashboard" && (
        <div className="flex flex-col gap-8">
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Widget Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Chart Card</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <ChartCard
      ...
      {activeTab === "Work" && (
        <div className="flex flex-col gap-8">
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Task Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Kanban Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Project Card</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <ProjectCard
      ...
      {activeTab === "Feed" && (
        <div className="flex flex-col gap-8">
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Activity Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Timeline Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Comment Card</h2>
      ...
      {activeTab === "Utility" && (
        <div className="flex flex-col gap-8">
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Attachment Card</h2>
            <div className="flex flex-col gap-2 max-w-lg">
              <AttachmentCard
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Empty State Card</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Integration Card</h2>
            <div className="flex flex-col gap-2 max-w-lg">
              <IntegrationCard
                icon={<MessageSquare />}
                iconVariant="primary"
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-semibold">Quick Action Card</h2>
