    ...
    <CRMBaseCard className={className}>
      <CardContent className="flex items-center gap-4 py-4">
        ...
        <button
          ...
          className={cn(
            "relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50",
        ...
        >
          <span
            className={cn(
              "pointer-events-none inline-block h-5 w-5 rounded-full bg-background shadow-sm transform ring-0 transition duration-200 ease-in-out",
