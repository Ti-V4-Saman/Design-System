...
/* -------------------------------------------------------------------------------------------------
 * Slider — range input on the Radix Slider primitive.
 *
 * Track = bg-muted, selected range = bg-primary, thumbs are ring-focusable. Supports single or
 * multiple thumbs (pass an array to value/defaultValue) and vertical orientation.
 * -----------------------------------------------------------------------------------------------*/
