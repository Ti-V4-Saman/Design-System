...
/* -------------------------------------------------------------------------------------------------
 * Toggle Group — a set of toggles (single or multiple selection) on the Radix ToggleGroup primitive.
 *
 * Items share the group's variant/size via context and join into a segmented control.
 * -----------------------------------------------------------------------------------------------*/
